...
import { getThemesList, isThemeValid, getThemeName, getThemeWord, hideWord, isValidLetter, correctLetter, containCheck, gameOver } from './data/hangman-stages.js';
...
const preHangman = async (username) => {
    ...
    isThemeValid(userThemeNum) ? startHangman(username, userThemeNum) : console.log(`Theme with number ${userThemeNum} is not valid.\nReturning to main menu...`);
